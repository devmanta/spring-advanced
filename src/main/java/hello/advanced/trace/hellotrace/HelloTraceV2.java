...
public class HelloTraceV2 {
    ...
    public TraceStatus beginSync(TraceId beforeTraceId, String msg) {
        TraceId nextTranceId = beforeTraceId.createNextId();
        long startTimeMs = System.currentTimeMillis();
        log.info("[{}] {}{}", nextTranceId.getId(), addSpace(START_PREFIX, nextTranceId.getLevel()), msg);
        return new TraceStatus(nextTranceId, startTimeMs, msg);
    }
